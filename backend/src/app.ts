...
import { logyMailService } from "./services/logyMailService.js";
...
wss.on("connection", (ws) => {
  ...
  clients.set(clientId, { ws, subscriptions: new Set(["vessels", "alerts", "shipment_update", "email_update", "dsr_remark_update"]) });
...
logyMailService.start(broadcast); // Logy Mail — automated DSR remark updates
